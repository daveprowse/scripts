...
main() {
    ...
    case $gnome_version in                
        ...
        46)
            ...
            echo;echo
            wget -q https://github.com/daveprowse/Draw-On-Gnome/releases/download/D.O.G.-ver-1.1/Draw-On-Gnome-ver-1-1.tar.xz
            tar -xf Draw-On-Gnome-ver-1-1.tar.xz
        ...
        48)
            ...
            echo;echo
            wget -q https://github.com/daveprowse/Draw-On-Gnome/releases/download/D.O.G.-ver-1.3/Draw-On-Gnome-ver-1-3.tar.xz
            tar -xf Draw-On-Gnome-ver-1-3.tar.xz
            mv Draw-On-Gnome draw-on-gnome@daveprowse.github.io/
            if [ ! -d ~/.local/share/gnome-shell/extensions ]; then
                echo "Creating extensions directory..."
                mkdir -p ~/.local/share/gnome-shell/extensions
...
2. Enable the Draw-On-GNOME extension (if necessary): \n
