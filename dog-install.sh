...
main() {
    ...
    case $gnome_version in                
        ...
        46)
            ...
            echo;echo
            wget -q https://github.com/daveprowse/Draw-On-Gnome/releases/download/D.O.G.-ver-9.0/Draw-On-Gnome-ver-9-0.tar.xz
            tar -xf Draw-On-Gnome-ver-9-0.tar.xz
        ...
        50)
            ...
            if [ ! -d ~/.local/share/gnome-shell/extensions ]; then
                echo "Creating extensions directory..."
                mkdir -p ~/.local/share/gnome-shell/extensions
            elif [ ! -w ~/.local/share/gnome-shell/extensions ]; then
                echo "Fixing extensions directory permissions..."
